// Gotta fix the date/ timestamp issue for whole database
...
module.exports = [
    ...
    },
    {
      ...
      release_date: 1996-05-12T23:00:00.000Z,
      category: 'FPS',
      review_intro: 'One of the most famous first-person shooters and at the same time the third installment of the series about the adventures of an arrogant hero. The title focuses on dynamics and effectiveness, while also serving a lot of humor.',
      review_body: 'Duke Nukem 3D is the third part of the series about an amazing prince fighting criminals, mafias and even terrifying aliens from outer space. Compared to the previous parts, made entirely in 2D, the game is a breakthrough, transferring the gameplay to a fully three-dimensional graphical environment and introducing the possibility of multiplayer games.',
      upvotes: 98,
      downvotes: 51,
      rating_count: 0,
      rating_sum: '0',
    ...
    },
    {
      ...
      release_date: 2002-04-30T23:00:00.000Z,
      category: 'RPG',
      review_intro: 'The third part of the epic action RPG series. The plot of TES III: Morrowind takes us back to the world of Tamriel. We play the role of a prisoner who is freed by the emperor and returns with a secret mission. It quickly began to be transpire that they are the incarnation of the legendary hero Nerevar.',
      review_body: 'Plot\n' +
